window.addEventListener('load', function () {
    ...
    function callWebService() {
        ...
        jQuery.ajax({
            url: "https://azuretest.azure-api.net/predict/execute?api-version=2.0&details=true",
            beforeSend: function (xhrObj) {
                xhrObj.setRequestHeader("Content-Type", "application/json;charset=utf-8");
                xhrObj.setRequestHeader("Ocp-Apim-Subscription-Key", "7d202d0a3d484ebba6d4c028c7c06cd8");
